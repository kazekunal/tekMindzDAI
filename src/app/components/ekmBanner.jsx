...
const EnterpriseKnowledgeBanner = ({ activeTab, setActiveTab }) => {
    return (
      <>
        {/* Font Import */}
        <style jsx global>{`
          ...
          <div className="relative z-10 text-center py-16 px-6">
            <div className="max-w-4xl mx-auto">
              <h1 className="text-5xl md:text-6xl font-light text-white mb-8" style={{ fontFamily: 'Roboto, sans-serif' }}>
                <span className="font-bold">Enterprise Knowledge</span> <span className="font-light">Management</span>
              </h1>
              <p className="text-gray-200 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto mb-12" style={{ fontFamily: 'Roboto, sans-serif' }}>
                Transform how your organization captures, organizes, and leverages knowledge with our AI-driven 
...
export default EnterpriseKnowledgeBanner;